...
func main() {
	...
	var backwardsCompatibleAPI bool
	...
	flag.BoolVar(&backwardsCompatibleAPI, "enable-legacy-api", false, "Enables legacy API routes (pre-v1) for backwards compatibility.")
	...
	case "httpd":
		...
		httpapi.Start(dir, port, tlsCrt, tlsKey, jwtPubKey, jwtPrivateKey, bind, authToken, backwardsCompatibleAPI)
	case "example":
